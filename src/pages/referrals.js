            ...
            >
              ...
              <div class="container-xxl d-flex flex-grow-1 flex-stack">
                ...
                <div class="d-flex align-items-center flex-shrink-0">
                  ...
                  {/* <!--begin::User--> */}
                  <div
                    class="d-flex align-items-center ms-3 ms-lg-4"
                  ...
                  <div class="d-flex align-items-center ms-3 ms-lg-4">
                    ...
                    <div
                      class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-active-bg-light w-30px h-30px w-lg-40px h-lg-40px fw-bold position-relative"
                ...
                {/* <!--begin::Container--> */}
                <div
                  class="header-menu-container container-xxl d-flex flex-stack h-lg-75px w-100"
                  id="kt_header_nav"
                >
                  {/* <!--begin::Menu wrapper--> */}
                  <div
                  ...
                  >
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                          ...
                          <div class="menu-active-bg px-4 px-lg-0">
                            ...
                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                              ...
                              {/* <!--begin:Tab pane--> */}
                              <div
                                class="tab-pane active w-lg-600px"
                    ...
                    <div class="flex-shrink-0 p-4 p-lg-0 me-lg-2">
                      <a
                        href="https://preview.keenthemes.com/html/metronic/docs"
                        class="btn btn-sm btn-light-primary fw-bold w-100 w-lg-auto"
                        data-bs-toggle="tooltip"
                        data-bs-trigger="hover"
                        data-bs-dismiss-="click"
                          ...
                          <div class="mb-10">
                            ...
                            <div>
                              <select
                                ...
                                data-dropdown-parent="#kt_menu_65a10ada6bc7a"
                    ...
                    <div class="card-body py-10">
                      ...
                      <div class="row mb-10">
                        ...
                        <div class="col-xl-6 mb-15 mb-xl-0 pe-5">
                          ...
                          <a
                            href="#"
                            class="btn btn-light btn-active-light-primary fw-bold"
                          >
                            Get Started
                          </a>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="card card-dashed flex-center min-w-175px my-3 p-6">
                            <span class="fs-4 fw-semibold text-info pb-1 px-2">
                              Net Earnings
                            </span>
                        ...
                        >
                          <li class="nav-item" role="presentation">
                            <a
                              ...
                              class="nav-link text-active-gray-800 me-4 active"
                              data-bs-toggle="tab"
                              role="tab"
                              href="#kt_referrals_1"
                            >
                          ...
                          <li class="nav-item" role="presentation">
                            <a
                              ...
                              class="nav-link text-active-gray-800"
                              data-bs-toggle="tab"
                              role="tab"
                              href="#kt_referrals_3"
                            >
            ...
            <div class="modal-body scroll-y m-5">
              ...
              >
                ...
                <div class="stepper-nav justify-content-center py-2">
                  {/* <!--begin::Step 1--> */}
                  <div
                    class="stepper-item me-5 me-md-15 current"
                    data-kt-stepper-element="nav"
                  >
                  ...
                  {/* <!--begin::Step 2--> */}
                  <div
                    class="stepper-item me-5 me-md-15"
                    data-kt-stepper-element="nav"
                  >
                ...
                {/* <!--begin::Form--> */}
                <form
                  class="mx-auto mw-500px w-100 pt-15 pb-10"
                  novalidate="novalidate"
